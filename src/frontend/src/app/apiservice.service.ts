...
export class ApiserviceService {
  ...
  getImages(event_id:string){
    if (event_id == "")
      // return this.http.get("http://3.145.139.195:5000/api/v1/resources/newclassify?event_id=0")
    ...
    // return this.http.get("http://3.145.139.195:5000/api/v1/resources/newclassify?event_id="+event_id)
  ...
  postAnnotation(data:string) {
    ...
    console.log(body)
    // return this.http.post('http://3.145.139.195:5000/api/v1/resources/annotate', body,{'headers':headers})
