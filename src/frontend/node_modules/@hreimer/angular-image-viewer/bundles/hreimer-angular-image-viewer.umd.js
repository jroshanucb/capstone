(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('@angular/platform-browser'), require('@angular/platform-browser/animations')) :
    typeof define === 'function' && define.amd ? define('@hreimer/angular-image-viewer', ['exports', '@angular/core', '@angular/common', '@angular/forms', '@angular/platform-browser', '@angular/platform-browser/animations'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.hreimer = global.hreimer || {}, global.hreimer['angular-image-viewer'] = {}), global.ng.core, global.ng.common, global.ng.forms, global.ng.platformBrowser, global.ng.platformBrowser.animations));
}(this, (function (exports, core, common, forms, platformBrowser, animations) { 'use strict';
    ...
    AngularImageViewerComponent.propDecorators = {
        src: [{ type: core.Input }],
        screenHeightOccupied: [{ type: core.Input }],
...
//# sourceMappingURL=hreimer-angular-image-viewer.umd.js.map
